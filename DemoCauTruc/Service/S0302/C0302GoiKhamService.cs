...
{
    public class C0302GoiKhamService : IC0302GoiKhamService
    {
        private readonly AppDbContext _dbService;
        private readonly ILogger<C0302GoiKhamService> _logger;
        private readonly IHttpContextAccessor _httpContextAccessor;
        public C0302GoiKhamService(AppDbContext dbService, ILogger<C0302GoiKhamService> logger, IHttpContextAccessor httpContextAccessor)
        {
        ...
        FilterByDayAsync(string tuNgay, string denNgay, long IDChiNhanh, int page = 1, int pageSize = 10)
        {
            ...
            var allData = await _dbService.GoiKhamSTOs
                .FromSqlRaw("EXEC Thai_DSGoiKhamBenhLocTheoNgay @TuNgay, @DenNgay, @IdChiNhanh",
